...
import com.ah.photoapp.models.Photo
...
class MainAdapter(var photos:List<Photo>, var clickListener : View.OnClickListener?) : RecyclerView.Adapter<MainAdapter.PhotoHolder>() {
    ...
    inner class PhotoHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            itemView.tag = this
                                                                                // Remark codes for Bypassing SDK 26 Bug Issues Referal problems
            tags = itemView.findViewById<TextView>(R.id.tags)                   // itemView.findViewById(R.id.tags) as TextView
            likes = itemView.findViewById<TextView>(R.id.likes)                 // itemView.findViewById(R.id.likes) as TextView
            favorites = itemView.findViewById<TextView>(R.id.favorites)         // itemView.findViewById(R.id.favorites) as TextView
            photo_item = itemView.findViewById<ImageView>(R.id.photo_item)      //  itemView.findViewById(R.id.photo_item) as ImageView
        }
    }
